...
class _AddProductImagesState extends State<AddProductImages> {
  ...
  Widget build(BuildContext context) {
    return ModalProgressHUD(
      ...
      dismissible: false,
      child:
          new SimpleDialog(title: new Text("Select Images Max:3"), children: <
              Widget>[
        Container(
          height: 100.0,
          child: new Row(
        ...
        Mutation(
              ...
              return new MaterialButton(
                ...
                onPressed: () async {
                  ...
                  if (_file1 != null && _file1.path.isNotEmpty ||
                    ...
                    runMutation({
                      'id': widget.productId,
                      'images': [_file1 ?? null, _file2 ?? null, _file3 ?? null]
                    });
                  } else {
                    setState(() {
                      _loaderState = false;
            ...
            update: (Cache cache, QueryResult result) {
              if (result.hasErrors) {
                ...
                //  Flushbar(message: "added",
                //  duration: new Duration(milliseconds: 2),

                //  )..show(context);
                // Navigator.pushAndRemoveUntil(
                //   context,
                //   MaterialPageRoute(builder: (context) => new MYProducts()),
